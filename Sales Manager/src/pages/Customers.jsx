...
import { Search, Plus, Calendar, MessageSquareText, Edit2, Trash2, X, User, StickyNote, Send, Clock } from 'lucide-react';
...
const CustomerModal = ({ onClose, onSave, initialData }) => {
  const [formData, setFormData] = useState(initialData || {
    gymName: '', name: '', email: '', phone: '', purchaseDate: '', renewalDate: '', annualFee: 1200, status: 'Active'
  });
